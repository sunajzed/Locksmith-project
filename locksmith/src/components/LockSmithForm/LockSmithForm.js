...
//   const countryCodeOptions = [{ label: "+61 (Australia)", value: "+61" }];
...
//     }${formData.contact_number.replace(/^0/, "")}`;
...
//       <h2 className="text-center mb-4">Locksmith Profile Setup</h2>
  ...
  const handleChange = (e) => {
    ...
    if (files && files.length > 0) {
      ...
      if (file.size > 10 * 1024 * 1024) {
        ...
        setFileFieldErrors((prev) => ({
          ...prev,
          [name]: "❌ File size exceeds 10MB. Please upload a smaller file.",
        }));
        setFormData((prev) => ({
          ...prev,
          [name]: null,
  ...
  return (
    <div className="container locksmith-form">
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <div className="form-group">
          <label>License File (Max 10MB)</label>
          {fileFieldErrors.license_file && (
            <div className="text-danger warning-message">
              {fileFieldErrors.license_file}
            </div>
