...
//     // Additional validation for automotive services
//     if (
//       serviceType === "automotive" &&
...
//       setMessage({
//         type: "warning",
//         text: "Please fill in all automotive details including number of buttons.",
//       });
//       return;
//     }
...
//       setMessage({
//         type: "warning",
//         text: "Invalid price. Enter a valid number.",
//       });
//       return;
//     }
...
//       // Add automotive details if service type is automotive
...
//           number_of_buttons: Number(carKeyDetails.number_of_buttons), // Ensure this is a number
//         };
//       }
...
//       });
//       setIsConfirmed(false); // Reset confirmation state on error
//     }
//   };
//   return (
//     <Container className="create-service-container">
...
//                   <Form.Label>Number of Buttons</Form.Label>
//                   {carKeyDetails.year ? (
//                     // Get all unique button options for the selected year
//                     [
//                       ...new Set(
//                         years
...
//                       ),
//                     ].length > 1 ? (
//                       // If multiple options, show a dropdown
//                       <Form.Control
//                         as="select"
...
//                       </Form.Control>
//                     ) : (
//                       // If only one option, show it as readonly
//                       <Form.Control
//                         type="number"
//                         value={
//                           years.find(
...
//                 The final displayed price will include: <br />- Locksmith’s
//                 price (Includes 10% GST) <br />- 10% service fee <br />- $40
//                 platform fee
//               </Tooltip>
//             }
//           >
...
//         <Modal.Body>
//           <p>
//             The price you entered is the base amount before the service fee and
//             platform fee are added. Are you sure you want to proceed with this
//             price?
//           </p>
//         </Modal.Body>
//         <Modal.Footer>
