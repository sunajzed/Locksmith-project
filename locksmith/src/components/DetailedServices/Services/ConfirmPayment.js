...
//   const { service, basePrice, additionalKeys = 0, additionalKeyPrice = 10 } = location.state;
//   const [isProcessing, setIsProcessing] = useState(false);
//   const [paymentStatus, setPaymentStatus] = useState(null);

//   // Calculate the total price including additional keys if any
//   const totalPrice = additionalKeys > 0 
//     ? parseFloat(basePrice) + (additionalKeys * additionalKeyPrice)
...
//   const gst = (totalPrice * gstPercentage / 100).toFixed(2);
//   const commission = (totalPrice * commissionPercentage / 100).toFixed(2);
//   const locksmithFee = (totalPrice - parseFloat(gst) - parseFloat(commission) - platformFeeFixed).toFixed(2);
...
//     try {
//       // Prepare booking data with the correct total price
//       const bookingData = {
...
//       // 2. Process payment with the correct amount
...
//               {additionalKeys > 0 && (
//                 <>
//                   <li>Base Service: ${parseFloat(basePrice).toFixed(2)}</li>
//                   <li>Additional Keys ({additionalKeys} × ${additionalKeyPrice}): ${(additionalKeys * additionalKeyPrice).toFixed(2)}</li>
//                 </>
//               )}
//               <li>GST ({gstPercentage}%): ${gst}</li>
//               <li>Commission ({commissionPercentage}%): ${commission}</li>
//               <li>Platform Fee: ${platformFeeFixed.toFixed(2)}</li>
...
const ConfirmPayment = () => {
        ...
        <div className="luxury-service-card">
          <div className="service-icon">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M12 6C10.9 6 10 6.9 10 8C10 9.1 10.9 10 12 10C13.1 10 14 9.1 14 8C14 6.9 13.1 6 12 6ZM12 16C10.9 16 10 16.9 10 18C10 19.1 10.9 20 12 20C13.1 20 14 19.1 14 18C14 16.9 13.1 16 12 16Z" fill="#8B5CF6"/>
            </svg>
          </div>
          ...
          <div className="breakdown-grid">
            ...
            {additionalKeys > 0 && (
              <>
                ...
                <div className="breakdown-row">
                  <span>Additional Keys  ({additionalKeys} × ${additionalKeyPrice}): ${(additionalKeys * additionalKeyPrice).toFixed(2)}</span>
            ...
            <div className="breakdown-row">
              ...
              <span>${platformFeeFixed.toFixed(2)}</span>
            </div>
            
            <div className="breakdown-row">
              <span>Locksmith Fee</span>
              <span>${locksmithFee}</span>
            </div>
  ...
  alignItems: 'center',
  gap: '8px',
  color: '#374151', // nice readable gray
  fontSize: '14px',
}}>
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C6.5 2 2 6.5 2 12C2 17.5 6.5 22 12 22C17.5 22 22 17.5 22 12C22 6.5 17.5 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z" fill="#4B5563"/>
    <path d="M12 6V12L16 14" fill="#4B5563"/>
  </svg>
  <span>Your service is scheduled for: <strong>Now</strong> (immediate processing)</span>
          ...
          >
            {isProcessing ? (
              ...
              <>
                ...
                <svg className={`arrow-icon ${isHovering ? 'hover' : ''}`} width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="luxury-success-container">
      <div className={`luxury-success-card ${animate ? 'animate' : ''}`}>
        ...
        <div className="success-icon-circle">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M22 11.08V12C21.9988 14.1564 21.3005 16.2547 20.0093 17.9818C18.7182 19.709 16.9033 20.9725 14.8354 21.5839C12.7674 22.1953 10.5573 22.1219 8.53447 21.3746C6.51168 20.6273 4.78465 19.2461 3.61096 17.4371C2.43727 15.628 1.87979 13.4881 2.02168 11.3363C2.16356 9.18455 2.99721 7.13631 4.39828 5.49706C5.79935 3.85781 7.69279 2.71537 9.79619 2.24013C11.8996 1.7649 14.1003 1.98232 16.07 2.85999" stroke="#8B5CF6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        ...
        <div className="success-content">
          ...
          <div className="success-actions">
            <button 
              className="luxury-home-button"
              onClick={() => navigate("/")}
            >
              Return Home
            </button>
            <button 
              className="luxury-dashboard-button"
