...
// const revenueData = [
//   { name: "Lock Repair", value: 400 },
//   { name: "Key Duplication", value: 300 },
//   { name: "Emergency Unlock", value: 500 },
//   { name: "New Lock Installation", value: 350 },
// ];

// const locksmiths = [
//   { id: 1, name: "John Doe", transactions: 45 },
//   { id: 2, name: "Alice Johnson", transactions: 40 },
//   { id: 3, name: "Robert Brown", transactions: 38 },
// ];

// const csvData = [
//   ["ID", "Locksmith", "Transactions"],
//   ...locksmiths.map((item) => [item.id, item.name, item.transactions]),
// ];
...
//           <Card className="mb-4">
//             <Card.Body>
//               <Card.Title>Revenue Breakdown (by Service)</Card.Title>
//               <ResponsiveContainer width="100%" height={300}>
//                 <PieChart>
//                   <Pie data={revenueData} cx="50%" cy="50%" outerRadius={100} fill="#00C49F" dataKey="value" label>
...
//             </tbody>
//           </Table>
//           <CSVLink data={csvData} filename="top_locksmiths.csv">
